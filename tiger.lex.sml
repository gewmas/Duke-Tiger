...
fun yyQ25 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction33(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ92(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ91(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ93(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"3"
              ...
              then if inp <= #"/"
                  then yyAction41(strm, yyNO_MATCH)
                  else yyQ94(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp <= #"9"
              then yyQ94(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
              else yyAction41(strm, yyNO_MATCH)
      (* end case *))
