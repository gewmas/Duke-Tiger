       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
              else yyAction40(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ77(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
              else yyAction40(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction33(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ85(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ84(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ86(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\""
                  ...
                  else yyQ90(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"\\"
